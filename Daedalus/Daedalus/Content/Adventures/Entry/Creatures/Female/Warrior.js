const texture = require("../../Textures/index.js").femaleWarrior;
const creature = new Creature(GameObject);
creature.Name = "Female-Warrior";
creature.Description = "A female warrior";
...
animation_MoveLeft_3.Origin = new Vector2(11, 34);
animation_MoveLeft_3.Box = new Rectangle(61, 105, 22, 34);
...
animation_MoveRight_1.Origin = new Vector2(11, 34);
animation_MoveRight_1.Box = new Rectangle(3, 35, 22, 34);
