const texture = require("../../Textures/index.js").femaleTownfolk;
const creature = new Creature(GameObject);
creature.Name = "Female-Townfolk";
creature.Description = "A female townfolk";
...
animation_MoveDown_1.Origin = new Vector2(13, 32);
animation_MoveDown_1.Box = new Rectangle(1, 66, 26, 32);
...
animation_MoveDown_2.Origin = new Vector2(14, 32);
animation_MoveDown_2.Box = new Rectangle(29, 66, 28, 32);
...
animation_MoveDown_3.Origin = new Vector2(13, 32);
animation_MoveDown_3.Box = new Rectangle(59, 66, 26, 32);
...
animation_MoveDown_4.Box = new Rectangle(29, 66, 28, 32);
...
animation_MoveLeft_1.Origin = new Vector2(10, 32);
animation_MoveLeft_1.Box = new Rectangle(4, 99, 20, 32);
...
animation_MoveLeft_2.Origin = new Vector2(10, 32);
animation_MoveLeft_2.Box = new Rectangle(33, 99, 20, 32);
...
animation_MoveLeft_3.Origin = new Vector2(11, 32);
animation_MoveLeft_3.Box = new Rectangle(61, 99, 22, 32);
...
animation_MoveLeft_4.Origin = new Vector2(10, 32);
animation_MoveLeft_4.Box = new Rectangle(33, 99, 20, 32);
...
animation_MoveRight_1.Origin = new Vector2(11, 32);
animation_MoveRight_1.Box = new Rectangle(3, 33, 22, 32);
...
animation_MoveRight_2.Origin = new Vector2(10, 32);
animation_MoveRight_2.Box = new Rectangle(33, 33, 20, 32);
...
animation_MoveRight_3.Origin = new Vector2(10, 32);
animation_MoveRight_3.Box = new Rectangle(62, 33, 20, 32);
...
animation_MoveRight_4.Origin = new Vector2(10, 32);
animation_MoveRight_4.Box = new Rectangle(33, 33, 20, 32);
...
animation_StandDown_1.Origin = new Vector2(14, 32);
animation_StandDown_1.Box = new Rectangle(29, 66, 28, 32);
...
animation_StandLeft_1.Origin = new Vector2(10, 32);
animation_StandLeft_1.Box = new Rectangle(33, 99, 20, 32);
...
animation_StandRight_1.Origin = new Vector2(10, 32);
animation_StandRight_1.Box = new Rectangle(33, 33, 20, 32);
...
animation_StandUp_1.Origin = new Vector2(14, 32);
animation_StandUp_1.Box = new Rectangle(29, 0, 28, 32);
