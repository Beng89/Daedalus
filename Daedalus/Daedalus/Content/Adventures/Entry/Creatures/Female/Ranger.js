const texture = require("../../Textures/index.js").femaleRanger;
const creature = new Creature(GameObject);
creature.Name = "Female-Ranger";
creature.Description = "A female ranger";
...
animation_MoveUp_1.Box = new Rectangle(0, 0, 26, 34);
